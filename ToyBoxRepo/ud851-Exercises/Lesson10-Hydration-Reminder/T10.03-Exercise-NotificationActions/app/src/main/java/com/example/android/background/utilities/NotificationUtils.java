...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 1939;
    private static final int ACTION_PERFORMED_PENDING_INTENT_ID = 4652;
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        Intent performReminderIntent = new Intent(context, WaterReminderIntentService.class);
        performReminderIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        PendingIntent incrementPendingIntent = PendingIntent.getService(
                context,
                ACTION_PERFORMED_PENDING_INTENT_ID,
                performReminderIntent,
                PendingIntent.FLAG_UPDATE_CURRENT
        );
        NotificationCompat.Action performReminderAction  = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                "I did it!",
