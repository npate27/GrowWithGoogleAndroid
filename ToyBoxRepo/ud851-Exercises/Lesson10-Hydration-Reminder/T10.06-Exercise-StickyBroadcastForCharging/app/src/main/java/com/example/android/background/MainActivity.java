...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // COMPLETED (4) If your user is not on M+, then...
            ...
            IntentFilter supportChargingIntentFilter = new IntentFilter();
            supportChargingIntentFilter.addAction(Intent.ACTION_BATTERY_CHANGED);
            Intent receiverIntent = registerReceiver(null, supportChargingIntentFilter);
            int status = receiverIntent.getExtras().getInt(BatteryManager.EXTRA_STATUS);
