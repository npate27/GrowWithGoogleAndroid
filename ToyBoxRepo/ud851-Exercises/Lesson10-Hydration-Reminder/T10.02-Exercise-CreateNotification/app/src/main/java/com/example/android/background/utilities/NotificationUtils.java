...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 801;
    public static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "reminder_water_channel_id";
