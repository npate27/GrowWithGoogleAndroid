...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long totalMinsUntilBoarding = info.getMinutesUntilBoarding();
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(totalMinsUntilBoarding);
        long minsLessHoursUntilBoarding =
                totalMinsUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);

        String hoursAndMinsUntilBoarding = getString(R.string.countDownFormat,
                hoursUntilBoarding, minsLessHoursUntilBoarding);
        mBinding.textViewBoardingInCountdown.setText(hoursAndMinsUntilBoarding);
