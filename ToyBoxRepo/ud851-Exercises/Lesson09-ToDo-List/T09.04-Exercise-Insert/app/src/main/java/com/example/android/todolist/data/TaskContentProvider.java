    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match){
            case TASKS:
                ...
                if(result> 0){
                    returnUri = ContentUris.withAppendedId(TaskContract.TaskEntry.CONTENT_URI, result);
                } else {
                    throw new android.database.sqlite.SQLiteException("Failed inserting into " + uri);
                }
                break;
            default:
