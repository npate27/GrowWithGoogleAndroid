...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String  KEY_QUERY_URL = "query_url_key";
    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private final static String  KEY_RAW_JSON = "json_raw_key";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_QUERY_URL, urlText);
        ...
        outState.putString(KEY_RAW_JSON, jsonText);
    }
