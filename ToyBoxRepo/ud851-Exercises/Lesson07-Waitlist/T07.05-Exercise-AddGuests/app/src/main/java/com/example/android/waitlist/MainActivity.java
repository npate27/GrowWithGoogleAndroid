...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mNewGuestNameEditTest, mNewPartySizeEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewGuestNameEditTest = (EditText) findViewById(R.id.person_name_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        if(mNewPartySizeEditText.getText().toString().equals("") || mNewGuestNameEditTest.getText().toString().equals("")){
            return;
        }
        String guestName = mNewGuestNameEditTest.getText().toString();
        ...
        mNewGuestNameEditTest.getText().clear();
