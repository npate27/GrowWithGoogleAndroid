...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String metricPreferenceString = sharedPreferences.getString(context.getString(R.string.pref_units_key),
                context.getString(R.string.pref_units_metric));
        String metricChoice = context.getString(R.string.pref_units_metric);
        return (metricPreferenceString.equals(metricChoice));
    }
