...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData(){
        String locationPreference = SunshinePreferences.getPreferredWeatherLocation(this);
        new FetchWeatherAsyncTask().execute(locationPreference);
    }
    ...
    public class FetchWeatherAsyncTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
            String[] weatherJSONStrings = null;
            if(params.length > 0) {
                try {
                    String param = params[0];
                    String jsonResponse = NetworkUtils.getResponseFromHttpUrl(NetworkUtils.buildUrl(param));
                    weatherJSONStrings = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonResponse);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            return weatherJSONStrings;
        }
