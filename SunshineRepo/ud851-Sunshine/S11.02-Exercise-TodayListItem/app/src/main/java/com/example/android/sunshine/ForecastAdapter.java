...
//      COMPLETED (14) Otherwise, throw an IllegalArgumentException
        ...
        switch(viewType){
            case VIEW_TYPE_TODAY:
                layoutToUse = R.layout.list_item_forecast_today;
                break;
            case VIEW_TYPE_FUTURE_DAY:
                layoutToUse = R.layout.forecast_list_item;
                break;
            default:
                throw new IllegalArgumentException("Error: not valid viewType");
        }
        View view = LayoutInflater
            .from(mContext)
            .inflate(layoutToUse, viewGroup, false);
