...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
        ...
        dateString = mContext.getString(R.string.a11, dateString)
        ...
        String[] highAndLowTemps = highAndLowTemperature.split(" / ");

        forecastAdapterViewHolder.weatherDate.setText(dateString);
        forecastAdapterViewHolder.weatherDescription.setText(description);
        forecastAdapterViewHolder.weatherLow.setText(highAndLowTemps[0]);
        forecastAdapterViewHolder.weatherHigh.setText(highAndLowTemps[1]);
...
//      COMPLETED (4) Replace the weatherSummary TextView with individual weather detail TextViews
        final TextView weatherDate, weatherDescription, weatherHigh, weatherLow;
