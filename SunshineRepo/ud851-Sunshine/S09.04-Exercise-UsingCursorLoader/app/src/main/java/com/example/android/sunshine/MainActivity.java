...
//  COMPLETED (16) Create a String array containing the names of the desired data columns from our ContentProvider
    public static final String[] WEATHER_DATA_COLS = {
        WeatherContract.WeatherEntry.COLUMN_DATE,
        WeatherContract.WeatherEntry.COLUMN_WEATHER_ID,
        WeatherContract.WeatherEntry.COLUMN_MAX_TEMP,
        WeatherContract.WeatherEntry.COLUMN_MIN_TEMP
    };
//  COMPLETED (17) Create constant int values representing each column name's position
...
//      COMPLETED (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        switch(id){
            case ID_FORECAST_LOADER:
                ...
                return new CursorLoader(this, queryUri, WEATHER_DATA_COLS, selection, null,
                        WeatherContract.WeatherEntry.COLUMN_DATE);
            default:
                throw new RuntimeException("Loader does not exist with ID: " + id);
        }
    }
